<div x-show="step === 4" class="w-full flex flex-col justify-center items-center px-8 sm:px-4 xl:px-0">
    <div class="max-w-2xl flex flex-col gap-y-4 text-left sm:text-center items-center">
        <h3 class="font-semibold text-brand-green">Your application has been submitted successfully.</h3>
        <p class="text-basic-black">An account on this portal has been created for you. You can go to the dashboard to track your application status. </p>
        <div class="flex flex-col sm:flex-row justify-center gap-4 my-4">
            {{-- <div>
                <div x-data="{ loginModalOpen: false }">
                                ...
                                <div class="w-full flex flex-col justify-start items-start gap-4 px-6 mt-2">
                                    <div class="w-full flex justify-start items-start">
                                        <div class="grid gap-4 justify-items-start">
                                            ...
                                            <form action="" class="w-full grid gap-y-4">
                                                <div class="w-full grid grid-cols-1 gap-2 custom-select">
                                                    <label class="text-left" for="e_add">
                                                        Email address
                                                        <span class="text-required-red">*</span>
                                                    </label>
                                                    <input type="email" name="e_add" id="e_add" class="w-full">
                                                </div>
                                                <div class="w-full grid grid-cols-1 gap-2 custom-select">
                                                    ...
                                                    <input type="password" name="pswd" id="pswd" class="w-full">
                                                </div>
                                                <div class="mt-2 w-full flex">
                                                    <input type="relative bg-white border-solid border-2 border-brand-green rounded-lg mx-auto max-w-3xl pt-4 pb-10 px-4" class="w-5 h-5 mr-2 rounded-md checked:bg-brand-green" id="rem" name="rem" value="">
                                                    <label for="remember">
                                                        Remember me
                                                    </label>
                                                </div>
                                                <a href="/user-account" class="w-full flex">
                                                    <div class="w-full px-4 py-2 flex items-center justify-center rounded-lg  bg-brand-green hover:bg-brand-light-green text-white border-2 shadow-md">
                    ...
                    <button type="button" class="w-52 flex items-center justify-center px-4 py-2 text-sm rounded-lg bg-brand-green hover:bg-brand-light-green text-white border-2 shadow-md text-left" x-on:click="loginModalOpen = !loginModalOpen">
                        Login to Portal
            ...
            <a href="/" class="hover:opacity-100">
                <button type="button" class="w-52 flex items-center justify-center px-4 py-2 text-sm rounded-lg bg-brand-light-green hover:bg-brand-green text-white border-2 shadow-md text-left">
                    Apply for Insurance
                    <svg class="pl-2" width="30" height="30" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4" d="M16.5 9.5C16.5 13.366 13.366 16.5 9.5 16.5C5.63401 16.5 2.5 13.366 2.5 9.5C2.5 5.63401 5.63401 2.5 9.5 2.5C13.366 2.5 16.5 5.63401 16.5 9.5Z" fill="white" stroke="white"/>
                        <path d="M8.55477 12.71C8.41227 12.71 8.26977 12.6575 8.15727 12.545C7.93977 12.3275 7.93977 11.9675 8.15727 11.75L10.4073 9.5L8.15727 7.25C7.93977 7.0325 7.93977 6.6725 8.15727 6.455C8.37477 6.2375 8.73477 6.2375 8.95227 6.455L11.5998 9.1025C11.8173 9.32 11.8173 9.68 11.5998 9.8975L8.95227 12.545C8.83977 12.6575 8.69727 12.71 8.55477 12.71Z" fill="white"/>
