...
<div>
    ...
    <div x-data="{ loginModalOpen: false }" @open-modal.window="loginModalOpen = true">
                            ...
                            <div class="grid gap-4 justify-items-start">
                                ...
                                <form wire:submit="login" class="w-full grid gap-y-4">
                                    <div class="grid grid-cols-1 gap-2 custom-select">
                                        ...
                                        <input type="email" wire:model="form.email" name="email" id="email" class="w-full">
                                    ...
                                    <div class="grid grid-cols-1 gap-2 custom-select">
                                        ...
                                        <input type="password" wire:model="form.password" name="password" id="password" class="w-full">
                                        <x-input-error :messages="$errors->get('form.password')" class="mt-2" />
                                    </div>
                                    <div class="mt-2 w-full flex">
                                        <input wire:model="form.remember" id="remember" type="checkbox" class="w-5 h-5 mr-2 rounded-md checked:bg-brand-green" name="remember">
                                        <label for="remember">
                                            Remember me
                                        </label>
                                    </div>
                                    <div class="w-full flex">
                                        <button type="submit" wire:loading.class="opacity-50 cursor-not-allowed" class="w-full px-4 py-2 flex items-center justify-center rounded-lg bg-brand-green hover:bg-brand-light-green text-white border-2 shadow-md text-sm">
                                            Login
        ...
        {{-- Trigger button --}}
        <div class="px-4 py-2 w-full hidden sm:flex items-center justify-center rounded-lg bg-brand-green hover:opacity-90 text-white border-2 border-brand-dark-green shadow-md cursor-default" x-on:click="loginModalOpen = !loginModalOpen">
            <button type="button" class="text-sm">
                Track Application
            </button>
