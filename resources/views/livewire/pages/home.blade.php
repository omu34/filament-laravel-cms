<x-app-layout>
    <div>
        ...
        <livewire:sections.our-experience-section />
        <livewire:sections.news-letter-section />
        <livewire:sections.contact-us-section />
        <livewire:sections.job-done-section />
        <livewire:sections.masika-team-section />
        <livewire:sections.featured-articles-section />


        <section class="bg-brand-tlg-five hidden  w-full justify-center p-8 sm:px-4 sm:py-12" data-aos="fade-up"
            data-aos-duration="1000" x-data="{
