<div data-aos="fade-up" data-aos-duration="1000">
    <div class="mx-auto pb-12 max-w-6xl flex flex-col gap-y-6" x-cloak x-data="tabs({{ $applications->toJson() }})">
        ...
        <div class="bg-white sm:px-4 xl:px-0">
            <div>
                <div class="grid grid-cols-7">
                    <div class="py-4"><span class="text-left font-bold">Name</span></div>
            ...
            <livewire:pages.dealers.sidebar-details />
    ...
    <script>
        function tabs(applications) {
            return {
                rows: applications,
                originalRows: applications,
                activeTab: 'All',
                filterStatus(status) {
