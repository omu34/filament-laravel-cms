<div class="w-full">
    <template x-for="(row, index) in rows" :key="index">
        <div class="grid grid-cols-7">
            <div class="flex py-4 border-t border-stroke"><span x-text="row.customer.user.full_name"></span></div>
            <div class="flex py-4 border-t border-stroke"><span x-text="row.reference_number"></span></div>
            <div class="flex py-4 border-t border-stroke"><span x-text="row.date_created"></span></div>
            <div class="flex py-4 border-t border-stroke"><span x-text="row.amount"></span></div>
            <div class="flex py-4 border-t border-stroke"><span x-text="row.agent.user.full_name"></span></div>
                        ...
                        x-transition:leave-end="translate-x-full">
                                        ...
                                        <div class="flex flex-col w-full">
                                            <div class="flex w-full">
                                                ...
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8">
                                                    <span x-text="row.customer.user.full_name"></span>
                                                </div>
                                            </div>
                                            <div class="w-full flex border-t border-stroke">
                                                ...
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8">
                                                    <span x-text="row.customer.user.email"></span>
                                                </div>
                                            </div>
                                            <div class="w-full flex border-t border-stroke">
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm py-4 pl-8 pr-4 sm:pr-6 md:pr-8 text-left font-bold">
                                                ...
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8">
                                                    <span x-text="row.customer.user.phone"></span>
                                                </div>
                                            </div>
                                            <div class="w-full flex border-t border-stroke">
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm py-4 pl-8 pr-4 sm:pr-6 md:pr-8 text-left font-bold">
                                                ...
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8">
                                                    <span x-text="row.customer.id_number ? row.customer.id_number : row.customer.passport_number"></span>
                                                </div>
                                            </div>
                                            <div class="w-full flex border-t border-stroke">
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm py-4 pl-8 pr-4 sm:pr-6 md:pr-8 text-left font-bold">
                                                ...
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8">
                                                    <span x-text="row.customer.kra_pin"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full">
                                        <div class="flex flex-col w-full">
                                            <div class="flex w-full">
                                                ...
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8">
                                                    <span x-text="row.customer.type === 'existing' ? 'Yes' : 'No'"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex w-full border-t border-stroke">
                                                ...
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8">
                                                    <span x-text="row.dealer.company_name"></span>
                                                </div>
                                            </div>
                                            <div class="flex w-full border-t border-stroke">
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm py-4 pl-8 pr-4 sm:pr-6 md:pr-8 text-left font-bold">
                                                ...
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8">
                                                    <span x-text="row.agent.user.full_name"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full">
                                        <div class="flex flex-col w-full">
                                            <div class="flex w-full">
                                                ...
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8">
                                                    <span class="capitalize" x-text="row.customer.income_source"></span>
                                                </div>
                                            </div>
                                            <div class="flex w-full border-t border-stroke">
                                                ...
                                                <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8 border-t border-stroke">
                                                    <span x-text="row.customer.extra_income ? 'Yes' : 'No'"></span>
                                                </div>
                                            </div>
                                            <template x-if="row.customer.extra_income">
                                                <template x-for="(income, index) in row.other_income" :key="index">                                                    
                                                    <div class="flex w-full border-t border-stroke">
                                                        <div class="w-1/2 sm:max-w-60 md:max-w-sm py-4 pl-8 pr-4 sm:pr-6 md:pr-8 text-left font-bold border-t border-stroke">
                                                            <div class="flex flex-col gap-2">
                                                                <span x-text="income.source"></span>
                                                            </div>
                                                        </div>
                                                        <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8 border-t border-stroke">
                                                            <span x-text="income.amount"></span>
                                                        </div>
                                                    </div>
                                                </template>
                                            </template>
                            ...
                            <div class="flex flex-col pt-4">
                                ...
                                <div class="w-full flex flex-col justify-start items-start gap-4">
                                    <div class="w-full">
                                        <div class="flex flex-col w-full">
                                            <template x-for="(upload, index) in row.document_uploads" :key="index"> 
                                                <div class="flex w-full">
                                                    <div class="w-1/2 sm:max-w-60 md:max-w-sm flex py-4 pl-8 pr-4 sm:pr-6 md:pr-8 text-left font-bold">
                                                        <span x-text="upload.document_type"></span>
                                                    </div>
                                                    {{-- upload.file_path --}}
                                                    <div class="w-1/2 sm:max-w-60 md:max-w-sm flex justify-start py-4 pl-4 sm:pl-6 md:pl-8 pr-8">
