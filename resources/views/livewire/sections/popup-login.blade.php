                            ...
                            <div class="grid gap-4 justify-items-start">
                                ...
                                <form wire:submit.prevent="login" class="w-full grid gap-y-4">
                                    <div class="grid grid-cols-1 gap-2 custom-select">
                                        ...
                                        <input type="email" wire:model="email" name="e_add" id="e_add" class="w-full">
                                        @error('email')
                                    ...
                                    <div class="grid grid-cols-1 gap-2 custom-select">
                                        ...
                                        <input type="password" wire:model="password" name="pswd" id="pswd" class="w-full">
                                        @error('password')
                                            <span class="text-required-red">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="mt-2 w-full flex">
                                        <input type="checkbox" class="w-5 h-5 mr-2 rounded-md checked:bg-brand-green" id="rem" name="rem" value="">
                                        <label for="remember">
                                            Remember me
                                        </label>
                                    </div>
