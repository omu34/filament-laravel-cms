...
<!-- About Us Section -->
<section class="bg-white w-full flex justify-center z-20  p-8 sm:px-4 sm:py-12" data-aos="fade-up" data-aos-duration="1000">
    @if ($sectiondata != null)
        <div
            ...
            <div class="mt-12 md:mt-0 ">
                <img src="{{asset('storage/'. $sectiondata->image) }}" alt="About Us Image"  class="rounded-lg shadow-md" />
            </div>
        </div>
    @endif
</section>
