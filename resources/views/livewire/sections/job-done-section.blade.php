...
<div data-aos-duration="1000" data-aos="fade-up" class="">
    @if ($sectiondata != null)
        <div id="countingSection"
            class="sticky top-0 mb-1 mt-1 md:py-8 h-screen-1/2 flex flex-col items-center justify-center sm:bg-gray-600  bg-no-repeat bg-cover"
            style="background-image: url('{{ asset('storage/' . $sectiondata->image) }}')">
            <div class="mb-2">
                            ...
                            <div class="relative px-4 mx-auto sm:px-6 lg:px-8">
                                <div class="max-w-7xl mx-auto">
                                    <dl class="bg-transparent rounded-lg sm:grid sm:grid-cols-3 gap-4">
                                        <div
                                            class="flex flex-col p-6 text-center border-gray-100  sm:border-0">
