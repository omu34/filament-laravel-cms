<div>
    ...
    <div x-data="{ modalOpen: false }">
        <div x-data="{}" x-ref="search" x-show="modalOpen" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="flex min-h-full items-center justify-center p-4 text-center">
                ...
                <div class="relative bg-white border-solid border-2 border-brand-green rounded-lg mx-auto max-w-3xl pt-4 pb-10 px-4" x-data="{}" x-cloak x-show="modalOpen"
                x-transition:enter="transition ease-out duration-300 transform"
        ...
        <div class="fixed bottom-5 md:bottom-8 right-5 z-[40]" x-on:click="modalOpen = !modalOpen">
            <div class="px-4 py-2 w-full flex items-center justify-center rounded-lg bg-brand-green hover:opacity-80 text-white border-2 border-brand-dark-green shadow-md">
                <button type="button" class="text-sm">
                    Loan Calculator
                </button>
                <svg class="ml-1" width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4" d="M12.5 16H6.5C4.70614 16 3.25 14.5439 3.25 12.75V5.25C3.25 3.45614 4.70614 2 6.5 2H12.5C14.2939 2 15.75 3.45614 15.75 5.25V12.75C15.75 14.5439 14.2939 16 12.5 16Z" fill="white" stroke="white"/>
                    <path d="M11.7498 4.2825H7.24984C6.47734 4.2825 5.83984 4.9125 5.83984 5.6925V6.4425C5.83984 7.215 6.46984 7.8525 7.24984 7.8525H11.7498C12.5223 7.8525 13.1598 7.2225 13.1598 6.4425V5.6925C13.1598 4.9125 12.5298 4.2825 11.7498 4.2825Z" fill="white"/>
                    <path d="M6.6198 11.19C6.5148 11.19 6.4173 11.1675 6.3273 11.13C6.2373 11.0925 6.1548 11.04 6.0873 10.9725C5.9448 10.83 5.8623 10.6425 5.8623 10.44C5.8623 10.3425 5.8848 10.245 5.9223 10.155C5.9598 10.0575 6.0123 9.98249 6.0873 9.90749C6.2598 9.73499 6.5223 9.65249 6.7623 9.70499C6.8073 9.71249 6.8598 9.72749 6.9048 9.74999C6.9498 9.76499 6.9948 9.78749 7.0323 9.81749C7.0773 9.83999 7.1148 9.87749 7.1448 9.90749C7.2123 9.98249 7.2723 10.0575 7.3098 10.155C7.3473 10.245 7.3623 10.3425 7.3623 10.44C7.3623 10.6425 7.2873 10.83 7.1448 10.9725C7.0023 11.115 6.8148 11.19 6.6198 11.19Z" fill="white"/>
                    <path d="M9.6123 11.19C9.4173 11.19 9.2298 11.115 9.0873 10.9725C8.9448 10.83 8.8623 10.6425 8.8623 10.44C8.8623 10.245 8.9448 10.05 9.0873 9.9075C9.3648 9.63 9.8673 9.63 10.1448 9.9075C10.2123 9.9825 10.2723 10.0575 10.3098 10.155C10.3473 10.245 10.3623 10.3425 10.3623 10.44C10.3623 10.6425 10.2873 10.83 10.1448 10.9725C10.0023 11.115 9.8148 11.19 9.6123 11.19Z" fill="white"/>
