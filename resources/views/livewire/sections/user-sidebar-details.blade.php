<div class="w-full">
    <template x-for="(row, index) in rows" :key="index">
        <div class="grid grid-cols-7 w-full items-center">
            ...
            <div class="flex py-4 border-t border-stroke"><span x-text="row.dealer"></span></div>
            ...
            <div x-data="{ sidebarOpen: false, status: 'Approved' }">
                <div x-data="{}" x-ref="search" x-show="sidebarOpen" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    <div class="flex min-h-full items-start justify-end text-center">
                        <div x-cloak @click="sidebarOpen = false" x-show="sidebarOpen" 
                        ...
                        <div class="relative bg-white rounded-l-md max-w-3xl pt-6 pb-4 flex flex-col" x-data="{}" x-cloak x-show="sidebarOpen"
                        x-transition:enter="transform transition ease-in-out duration-500 sm:duration-700"
                        x-transition:enter-start="translate-x-full"
                        x-transition:enter-end="translate-x-0"
                        x-transition:leave="transform transition ease-in-out duration-500 sm:duration-700"
                        ...
                        x-transition:leave-end="translate-x-full">
                                    ...
                                    <div class="flex flex-col w-full gap-4">
                                        <div class="flex items-center justify-between w-full">
                                            ...
                                            <div class="flex items-center justify-end px-4">
                                                <button type="button" @click="sidebarOpen = false" class="hover:opacity-80">
                            ...
                            <div class="w-full mt-4 px-8 flex justify-start" x-on:click="sidebarOpen = !sidebarOpen">
                ...
                <div class="flex cursor-default py-4 border-t border-stroke hover:opacity-80" x-on:click="sidebarOpen = !sidebarOpen">
