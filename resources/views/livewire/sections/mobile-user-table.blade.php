<div data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="w-full mx-auto pb-8 flex flex-col gap-y-3" x-cloak x-data="tabs()">
        ...
        <div class="w-full flex flex-col justify-center gap-y-6 px-8">
            <h3 class="text-brand-green text-center">Loan Applications</h3>
                    ...
                    <div class="w-full flex flex-col gap-y-2">
                        <div class="w-full flex gap-x-4 justify-evenly items-start cursor-default hover:opacity-80" x-on:click="noteContentOpen = !noteContentOpen">
                            ...
                            <div class="w-56 grid gap-x-4 gap-y-2 grid-cols-2">
                                <div><p class="text-sm font-semibold text-left">Dealer:</p></div>
                                <div><p class="text-sm text-left">Automotor Ltd</p></div>
                            ...
                            <div class="w-56 grid gap-x-4 gap-y-2 grid-cols-2">
                                ...
                                <div x-show="status === 'Pending'">
                                    <div class="flex">
                                        ...
                                        <span class="text-sm text-pending-yellow" x-text="status"></span>
                                    </div>
                                </div>
                                <div x-show="status === 'Denied'">
                                    <div class="flex">
                                        <img class="mr-2 w-fit" src="{{ asset('images/red-denied-icon.svg') }}" alt="Status icon">
                                        <span class="text-sm text-denied-red" x-text="status"></span>
                                    </div>
                                </div>
                            </div>
                            {{-- Mobile sidebar --}}
