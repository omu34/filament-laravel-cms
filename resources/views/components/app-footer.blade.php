<footer class="mt-auto">
    <div>
        <!-- Start of footer socials section -->
            <div class="py-8 bg-brand-light-green mx-auto">
                <div class="grid justify-items-start grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-x-10 gap-y-10 lg:gap-y-0 px-8 mx-auto">
                    @foreach($socials as $social)
                        <a href="{{ $social->url }}">
                            <div class="flex justify-center items-center gap-x-2">
                                <img src="{{ asset($social->icon) }}" alt="{{ $social->title }}">
                                <span class="text-sm font-bold text-brand-dark-green">
                                    {{ $social->title }}
                                </span>
                            </div>
                        </a>
                    ...
                    {{-- <a href="https://www.instagram.com/coopbankenya/?hl=en">
                        <div class="flex justify-center items-center gap-x-2">
                            ...
                            <span class="text-sm font-bold text-brand-dark-green">Instagram</span>
                        </div>
                    </a>
        ...
        {{-- Start of main footer --}}
            <div class="bg-brand-green px-8 xl:px-0">
                <div class="flex flex-col lg:flex-row py-12 px-4 lg:px-6 gap-4 md:gap-8 lg:gap-16 mx-auto w-full lg:max-w-7xl">
                    @if ($footer != null)
                    ...
                    @endif
                    <div class="w-full lg:w-2/3 flex lg:flex flex-col sm:grid sm:grid-cols-2 md:grid-cols-4 lg:flex-row gap-x-5 md:gap-x-10 lg:gap-x-20 gap-y-5 lg:gap-y-10 justify-end">
                ...
                <div class="flex flex-col sm:flex-row gap-y-4 sm:gap-y-0 justify-between w-full max-w-max sm:max-w-md md:max-w-xl lg:max-w-3xl xl:max-w-max">
                    <div class="flex justify-start items-center gap-x-3 lg:gap-x-6">
                        ...
                        <div class="flex flex-col xl:flex-row gap-0 sm:gap-x-4 sm:gap-y-2">
                            ...
                            <a href="/terms" class="w-32 px-4 py hidden sm:flex items-center justify-center rounded-lg bg-brand-dark-green hover:opacity-75 text-white border-2 border-white">
                    ...
                    <div class="flex items-center hover:opacity-80">
                        <a href="/terms" class="px-4 py flex sm:hidden items-center justify-center rounded-lg bg-brand-dark-green hover:opacity-75 text-white border-2 border-white">
                            <button type="button" class="text-sm">
                                Learn More
                            </button>
                            <span class="pl-2 text-sm">></span>    
                        </a>
                        <div class="flex" x-on:click="open = !open; if (!open) localStorage.setItem('privacyAlertClosed', '1')">
                            <svg class="ml-4" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.42857 12.9753C2.42857 7.70203 6.72669 3.40391 12 3.40391C17.2733 3.40391 21.5714 7.70203 21.5714 12.9753C21.5714 18.2486 17.2733 22.5468 12 22.5468C6.72669 22.5468 2.42857 18.2486 2.42857 12.9753ZM15.663 16.6384C16.1204 16.181 16.1204 15.4297 15.663 14.9723L13.6661 12.9753L15.663 10.9784C16.1204 10.521 16.1204 9.76966 15.663 9.3123C15.2057 8.85493 14.4543 8.85493 13.997 9.3123L12 11.3092L10.003 9.3123C9.54568 8.85493 8.79432 8.85493 8.33695 9.3123C7.87959 9.76966 7.87959 10.521 8.33695 10.9784L10.3339 12.9753L8.33695 14.9723C7.87959 15.4297 7.87959 16.181 8.33695 16.6384C8.57156 16.873 8.87247 16.9839 9.17 16.9839C9.46753 16.9839 9.76844 16.873 10.003 16.6384L12 14.6414L13.997 16.6384C14.2316 16.873 14.5325 16.9839 14.83 16.9839C15.1275 16.9839 15.4284 16.873 15.663 16.6384Z" fill="#FAFAFA" stroke="#FAFAFA" stroke-width="0.857143"/>
                            </svg> 
                        </div>
                    </div>                   
                </div>
